...
export default function StockTransactionList({ symbol }: { symbol: string }) {
          ...
          {transactions.map(tx => {
            ...
            return (
              <Box key={tx.id} sx={{
                ...
                p: 2, borderRadius: 4, bgcolor: '#f8fafc',
                ...
                <Box textAlign="right">
                  ...
                  <Typography variant="caption" sx={{ color: '#64748b' }}>
                    @ ${tx.price.toFixed(2)} = <strong>${total.toLocaleString(undefined, { minimumFractionDigits: 2 })}</strong>
                  </Typography>
                </Box>
              </Box>
            );
