        ...
        <Box maxWidth="1400px" mx="auto">
          ...
          {holdings.length === 0 ? (
            ...
            <Stack direction={{ xs: "column", lg: "row" }} spacing={4}>
              ...
              {/* --- ฝั่งซ้าย: รายการหุ้น (บังคับกว้าง 50%) --- */}
              ...
              {/* --- ฝั่งขวา: กราฟหุ้น (บังคับกว้าง 50%) --- */}
              <Box sx={{
                flex: 1,
                minWidth: 0,
                position: { lg: "sticky" },
                ...
                {/* Spacer: ตัวอักษรล่องหนเพื่อดันกราฟลงมาให้เสมอกับกล่องการ์ดฝั่งซ้าย */}
                <Typography variant="h6" mb={2} sx={{ visibility: "hidden" }}>
                  Spacer
                </Typography>
